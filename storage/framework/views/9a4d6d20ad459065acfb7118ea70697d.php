...
unset($__errorArgs, $__bag); ?>
    ...
    <?php $__env->startSection('auth_footer'); ?>
        ...
        <?php endif; ?>
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\PWL_POS\resources\views/login.blade.php ENDPATH**/ ?>